import extend from 'node.extend'; // Correction de l'import
import yaml from 'js-yaml'; // Correction de l'import
import fs from 'fs'; // Correction de l'import
import expressReverse from 'express-reverse'; // Correction de l'import
import path from 'path'; // Correction de l'import
import express, { Application } from 'express'; // Correction de l'import
